    ...
    <div class="row">
        <div class="card card-signup" data-background-color="orange">
            ...
            <?php     
                        ...
                        mysqli_query($link,"update admin set firstname='$_POST[firstname]', lastname='$_POST[lastname]', username='$_POST[username]', password='$_POST[password]', image='$imageName' where username='$_POST[username]'") or die(mysqli_error($link));
