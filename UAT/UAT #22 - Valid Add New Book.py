# Requirements : Username already exist and bookCode does not exist
# Test : Add new Book
# Result : Able to add book and see success message
...
def runTest():
	...
	try:
		element_present = EC.presence_of_element_located((By.ID,'successMsg addMsg'))
