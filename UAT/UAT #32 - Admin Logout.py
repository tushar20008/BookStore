# Requirements : Username already exist
# Test : Logout from admin account
# Result : Able to logout and direct to login page
...
def runTest():
	...
	try:
		element_present = EC.presence_of_element_located((By.CLASS_NAME,'login-page'))
