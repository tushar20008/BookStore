# Requirements : Username and Notification already exist
# Test : Update Notification status
# Result : Notification becomes read
...
def runTest():
	...
	driver.find_element_by_id("updateStatus").click()
	try:
		element_present = EC.presence_of_element_located((By.CLASS_NAME,'text-info'))
