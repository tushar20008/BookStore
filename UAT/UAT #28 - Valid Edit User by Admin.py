# Requirements : Username and searchUser already exist
# Test : Edit user information
# Result : Able to edit user information and see success message
...
def runTest():
	...
	try:
		element_present = EC.presence_of_element_located((By.ID,'successMsg editUserMsg'))
