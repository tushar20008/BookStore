# Requirements : Username and book already exist and book not issued by anyone
# Test : Delete Book from database
# Result : Able to delete book and see success message
...
def runTest():
	...
	try:
		element_present = EC.presence_of_element_located((By.ID,'successMsg deleteMsg'))
